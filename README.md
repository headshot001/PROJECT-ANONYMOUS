...
**AFTER YOU HAVE PLAYED YOUR GAME USE TYPE `CTRL` AND THEN `C` TO STOP ANY OF THE SCRIPTS AND `CTRL` AND `D` TO EXIT TERMUX**
...
**USE THE ABOVE PROCESS TO EXETUTE THE `pubgm.lua` or `codm.lua` file 👆**
